...
public class DependenteTest {
    ...
    public void test_validacao_idade_dependente_menor_de_dezoito_anos() {
        ...
        ResponsavelFamilia responsavel = ResponsavelFamilia.builder().nome("Flavio").email("flavio@gmail.com").cpf("123456789").dataDeNascimento(dataDeNascimentoResponsavel).genero(Genero.MASCULINO).estadoCivil(EstadoCivil.SOLTEIRO).build();
        ...
        Dependentes dependente = Dependentes.builder().nome("Flavio").genero(Genero.MASCULINO).dataDeNascimentoDependente(dataDeNascimentoDependente).responsavelFamilia(responsavel).build();
